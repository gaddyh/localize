# Design notes — localize

> The full rationale behind `localize`: how the schema, scenarios, generator, and
> self-validating grader were derived, and why each design choice earns its place.
